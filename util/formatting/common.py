...
# Maps color names to the corresponding mIRC numerical values
...
# hex color codes for mIRC numerical values
ColorsHex = bidict({
...
def is_bold(tag: Tag) -> bool:
    return (tag.tagName in ("b", "strong") or tag.attributes.get("bold", False))


def is_italic(tag: Tag) -> bool:
    return (tag.tagName in ("i", "em", "cite") or tag.attributes.get("italic",
                                                                     False))


def is_del(tag: Tag) -> bool:
    return (tag.tagName in ("del", "strike", "s") or tag.attributes.get("strike",
                                                                        False))


def is_underlined(tag: Tag) -> bool:
    return (tag.tagName == "u" or tag.attributes.get("underline", False))
